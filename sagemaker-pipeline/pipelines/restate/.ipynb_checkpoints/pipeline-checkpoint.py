...
### ATHENA PIPELINE BEGIN
    ...
    data_sources.append(ProcessingInput(
        ...
        dataset_definition=DatasetDefinition(
            ...
            athena_dataset_definition=AthenaDatasetDefinition(
                ...
                query_string="SELECT * FROM resvm.russia_2922",
                output_s3_uri="s3://sagemaker-ap-southeast-1-625467769535/athena/athena-resvm-russia/",
    ...
    flow_file_name = "restate-athena-russia.flow"
